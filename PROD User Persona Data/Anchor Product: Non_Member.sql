WITH MAIN AS (
    ...
    -- AND HDR.PROC_DATE = '1/1/2025 12:00:00 AM'
    -- AND HDR.DATETIME = '1/1/2025 10:00:10 AM'
    -- AND HDR.EMP_NO = '951'
    -- AND HDR.TILL_NO = '6'
...
CUMULATIVE AS ( -- CUMULATIVE: CALCULATES FOR THE CUMULATIVE TAG PER ITEM
    SELECT
        ...
        UPC,
        DESCRIPTION,
        SUM(TAG) OVER(PARTITION BY UPC, DESCRIPTION ORDER BY PROC_DATE, DATETIME, EMP_NO, TILL_NO, REGISTER_NO, TRANS_NO) AS CUMULATIVE_CNT
